 ...
 *
 * Local analytics: JSONL append to ~/.gstack/analytics/ (inline, inspectable, never sent remotely)
 */
...
# Clean up stale pending markers
...
function generateTelemetryPrompt(_ctx: TemplateContext): string {
  // Remote telemetry has been removed. Local analytics only.
  return '';
}
...
If you cannot determine the outcome, use "unknown". All analytics are local-only.
